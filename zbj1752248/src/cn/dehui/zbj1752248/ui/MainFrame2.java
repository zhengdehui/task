...
public class MainFrame2 extends JFrame {
    ...
    private JCheckBox         alipayCheckBox;
    ...
    public MainFrame2() throws NumberFormatException, IOException {
        ...
        if (initFile.exists()) {
            ...
            AlipayEmailChecker.sleepTime = Integer.parseInt(br.readLine());
            br.close();
        }

        setTitle("Email Checker V2");
        ...
        alipaySleepTextField = new JTextField(AlipayEmailChecker.sleepTime + "");
        ...
        saveAlipaySleepBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    AlipayEmailChecker.sleepTime = Integer.parseInt(alipaySleepTextField.getText());
                    File initFile = new File(initFilePath);
        ...
        egouCheckBox = new JCheckBox("eeee");

        fanliCheckBox = new JCheckBox("5555");

        fanhuanCheckBox = new JCheckBox("ffff");

        bigouCheckBox = new JCheckBox("bbbb");

        alipayCheckBox = new JCheckBox("aaaa");
        ...
        final JProgressBar egouProgressBar = new JProgressBar();
        egouProgressBar.setStringPainted(true);

        final JProgressBar fanliProgressBar = new JProgressBar();
        fanliProgressBar.setStringPainted(true);

        final JProgressBar fanhuanProgressBar = new JProgressBar();
        fanhuanProgressBar.setStringPainted(true);

        final JProgressBar bigouProgressBar = new JProgressBar();
        bigouProgressBar.setStringPainted(true);

        final JProgressBar alipayProgressBar = new JProgressBar();
        alipayProgressBar.setStringPainted(true);
                ...
                try {
                    ...
                    if (fanliCheckBox.isSelected()) {
                        checkerList.add(new FanliEmailChecker(emailList, outputFolderPath, startSignal, null,
                                fanliTimeLabel, fanliProgressBar));
                        doneCount++;
                    }
                    if (bigouCheckBox.isSelected()) {
                        checkerList.add(new FiveOneBiEmailChecker(emailList, outputFolderPath, startSignal, null,
                                bigouTimeLabel, bigouProgressBar));
                        doneCount++;
                    }
                    if (alipayCheckBox.isSelected()) {
                        checkerList.add(new AlipayEmailChecker(emailList, outputFolderPath, startSignal, null,
                                alipayTimeLabel, alipayProgressBar));
                        doneCount++;
                    }
        ...
        contentPane.add(egouCheckBox, "cell 0 2,grow");

        contentPane.add(egouProgressBar, "cell 2 2,grow");
        contentPane.add(fanliCheckBox, "cell 0 3,grow");

        contentPane.add(fanliProgressBar, "cell 2 3,grow");
        contentPane.add(fanhuanCheckBox, "cell 0 4,grow");

        contentPane.add(fanhuanProgressBar, "cell 2 4,grow");
        contentPane.add(bigouCheckBox, "cell 0 5,grow");
        contentPane.add(openFileButton, "cell 0 0,grow");
        contentPane.add(selectFolderButton, "cell 0 1,grow");

        contentPane.add(bigouProgressBar, "cell 2 5,grow");
        contentPane.add(alipayCheckBox, "cell 0 6,grow");

        contentPane.add(alipayProgressBar, "cell 2 6,grow");
    ...
    private void setEnabledAll(boolean enabled) {
        ...
        this.alipayCheckBox.setEnabled(enabled);
    }
}
