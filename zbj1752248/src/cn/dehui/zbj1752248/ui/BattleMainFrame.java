...
import cn.dehui.zbj1752248.BattleEmailChecker;
import cn.dehui.zbj1752248.EmailChecker;

public class BattleMainFrame extends JFrame {
        ...
        EventQueue.invokeLater(new Runnable() {
            public void run() {
                try {
                    ...
                    BattleMainFrame frame = new BattleMainFrame();
     ...
     */
    public BattleMainFrame() throws NumberFormatException, IOException {

        initFilePath = System.getProperty("user.home") + "/" + BattleEmailChecker.class.getSimpleName() + ".ini";
        File initFile = new File(initFilePath);
        if (initFile.exists()) {
            BufferedReader br = new BufferedReader(new FileReader(initFile));
            BattleEmailChecker.sleepTime = Integer.parseInt(br.readLine());
            br.close();
        }

        setTitle("Battle.net Email Checker");
        ...
        sleepTextField = new JTextField(BattleEmailChecker.sleepTime + "");
        ...
        saveAlipaySleepBtn.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
                ...
                try {
                    BattleEmailChecker.sleepTime = Integer.parseInt(sleepTextField.getText());
                    File initFile = new File(initFilePath);
                    ...
                    JOptionPane.showMessageDialog(BattleMainFrame.this, "数字有错");
        ...
        checkbox = new JCheckBox("Battle.net");
            ...
            public void actionPerformed(ActionEvent event) {
                ...
                try {
                    ...
                    if (checkbox.isSelected()) {
                        checkerList.add(new BattleEmailChecker(emailList, outputFolderPath, startSignal, null,
                    ...
                    e.printStackTrace();
                    JOptionPane.showMessageDialog(BattleMainFrame.this, e.getMessage(), "Error",
                            JOptionPane.ERROR_MESSAGE);
                }
            }
        });
        ...
        openFileButton.addActionListener(new ActionListener() {
            ...
            public void actionPerformed(ActionEvent e) {
                ...
                if (fc.showOpenDialog(BattleMainFrame.this) == JFileChooser.APPROVE_OPTION) {
        ...
        contentPane.add(checkbox, "cell 0 4,grow");
